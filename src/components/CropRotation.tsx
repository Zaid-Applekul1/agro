...
export function CropRotation() {
  const rotationData = cropRotationData as Record<string, RotationPlan[]>;
  const [selectedCrop, setSelectedCrop] = useState<string>('Winter Wheat');

  const currentRotation = rotationData[selectedCrop] || [];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
	          {Object.keys(rotationData).map(crop => (
            <button
              key={crop}
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6">
	          {currentRotation.map((yearPlan: RotationPlan, index: number) => (
              ...
              <div className={`p-6 rounded-lg border-2 ${
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1">
	                    {yearPlan.benefits.map((benefit: string, benefitIndex: number) => (
